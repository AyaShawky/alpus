...
<script type="text/javascript">
    (function () {
        var options = {
            facebook: "104775138375791", // Facebook page ID
            whatsapp: "97259874563", // WhatsApp number
        ...
        <div class="navbar navbar-expand-lg fixed-top Top-Navbar-Account">
            <div class="container-fluid">
                <a class="navbar-brand DeleteEffects" href="{{route('front.index')}}">
                    <img src="{{asset('front/img/LogosSite/Logo.svg')}}">
                </a>
        ...
        <div class="topSection mb-4">
            <div class="row">
                <div class="col-lg-4 col-12 col-12 DescribeContact">
                    <img src="{{asset('front/img/LogosSite/LogoWhite.svg')}}" class="mb-3">
                ...
                <div class="col-lg-4 col-md-12 col-12 ContactInfo d-flex justify-content-end">
                    <div class="Info">
                        ...
                        <div class="ContactLink">
                            <div class="link NotoRegular"><i class="fa fa-map-marker-alt"></i><span>غزة - شارع الوحدة -مقابل ملابس الواحة</span></div>
                            <div class="link"><i class="fa fa-phone"></i><span>97259874563+</span></div>
                            <div class="link mb-0"><i class="fa fa-envelope"></i><span>APLUS@gmail.com</span></div>
                        </div>
                    </div>
                </div>
            </div>
