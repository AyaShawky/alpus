                ...
                <div class="container-fluid">
                    <div class="description-slider">
                        <h1 class="NotoBold mb-4 wow fadeInRight">
                            منصة ايه بلس المنصة التعليمية
                            الأولى في فلسطين.
                        </h1>
                        <p class="NotoRegular mb-4  wow fadeInRight" data-wow-delay="0.5s">
                            المنصة الأولى على مستوى الوطن
                            لطلاب الثانوية العامة , التحق وتميز معنا.
                        </p>
                        <div class="LinkRegister  wow fadeInRight" data-wow-delay="1s">
                            <a class="btn NotoRegular text-white" href="#">
                                إلتحق الآن
                            </a>
                        </div>
                    </div>
...
@section('content')
                    ...
                    @if($key ==0)
                            <div class="col-lg-6 col-md-6 box field wow fadeInRight mb-4">
                                <div class="card p-3 border-0">
                                    <div class="card-img">
                                        <div class="img-card w-100" style="background: url('{{asset('front/img/Public/ImgFields1.png')}}');">
                                        </div>
                                    </div>
    ...
    <div class="opnion">
        <div class="container-fluid">
            <div class="top-section">
                <h2 class="TitleSection NotoBold text-center mb-4">
                    أراء عملائنا الأعزاء
                </h2>
                <p class="DescriptionSection NotoRegular text-center mx-auto">
                    " نسرد هنا لكم بعض أراء و تقييمات  عملائنا الأعزاء في منصتنا التعليمية "
                </p>
            </div>
            <div class="OpinionSlider owl-carousel owl-theme">
                <div class="item wow fadeInRight">
                    <div class="d-flex flex-column">
                        <div class="d-flex">
                            <img src="{{asset('front/img/Student/Student1.png')}}" class="flex-shrink-0">
                            <div class="OpinionDescription ps-4">
                                <h5 class="NotoRegular mb-4">الطالب / <span>عثمان أحمد</span></h5>
                                <p class="NotoRegular m-0 decribe-opinion">
                                    " قمت بالتسجيل بالمنصة عبر أحد الأصدقاء
                                    الذي قام بترشيحها لي فقد كنت متخوف
                                    من هذه المرحلة لكنها كانت فرصة ذهبية "
                                </p>
                ...
                <div class="item wow fadeInRight" data-wow-delay="0.4s">
                    <div class="d-flex flex-column">
                        <div class="d-flex">
                            <img src="{{asset('front/img/Student/Student2.png')}}" class="flex-shrink-0">
                            <div class="OpinionDescription ps-4">
                                <h5 class="NotoRegular mb-4">الطالب / <span>عثمان أحمد</span></h5>
                                <p class="NotoRegular m-0 decribe-opinion">
                                    " أشكر القائمين على هذه المنصة الرائعة
                                    فلقد حصلت على كم هائل من المعلومات
                                    الثمينة عبر طاقم أكاديمي مميز"
                                </p>
    ...
    <div class="ContactUs mt-4">
        ...
        <div class="container-fluid">
            ...
            <div class="top-section text-center">
                ...
                <a href="whatsapp://send?abid=+972592496114" class="btn LinkContact d-flex flex-row align-items-center justify-content-center wow zoomIn">
                    <img src="{{asset('front/img/Public/whatsapp.png')}}">
                    <span class="ps-3">970524865865+</span>
                </a>
            </div>
        </div>
    </div>
